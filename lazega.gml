...
<graphml xmlns="http://graphml.graphdrawing.org/xmlns" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://graphml.graphdrawing.org/xmlns http://graphml.graphdrawing.org/xmlns/1.0/graphml.xsd"><key attr.name="LawSchool" attr.type="int" for="node" id="d6"/>
<key attr.name="Practice" attr.type="int" for="node" id="d5"/>
<key attr.name="Age" attr.type="int" for="node" id="d4"/>
<key attr.name="Seniority" attr.type="int" for="node" id="d3"/>
<key attr.name="Office" attr.type="int" for="node" id="d2"/>
<key attr.name="Gender" attr.type="int" for="node" id="d1"/>
<key attr.name="Status" attr.type="int" for="node" id="d0"/>
